...
class vLLM_API:
    ...
    def __init__(self, model_name='dev-phi-35-vision-instruct'):
        ...
        self.sampling_params = {
            max_token_key: 1024,
            "temperature": 1.0 if 'o1' in model_name or 'gpt-5' in model_name  else 0.0,
            "top_p": 1.0,
        }        
...
class ApiWrapper:
    def __init__(self, model_name, sampling_params=None, is_embedding=False):
        ...
        self.max_token_key = 'max_completion_tokens' if 'o1' in model_name or 'gpt-5' in model_name else 'max_tokens'
    ...
    def get_response(self, messages):
        ...
        if self.is_embedding:
            ...
            if "gpt-5" in self.model_name or 'o1' in self.model_name or 'o4' in self.model_name:
