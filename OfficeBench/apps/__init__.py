...
from . import llm_app
from . import calculator_app
from . import scratchpad_app
...
AVAILABLE_APPS = {
    ...
    'email': email_app,
    'llm': llm_app,
    'scratchpad': scratchpad_app
}

AVAILABLE_ACTIONS = {
    'calculator': {
        'calculate': calculator_app.calculator_calculate,
    },
    'calendar': {
    ...
    'scratchpad': {
        'write': scratchpad_app.scratchpad
    }
}
